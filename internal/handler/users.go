...
func (s *Handler) ActivateUser(ctx context.Context, req *api.TokenRequest) (*api.UserResponse, error) {
	...
	if err != nil {
		return &api.UserResponse{}, errors.Wrap(err, "failed activate user")
	}
...
func (s *Handler) NewUser(ctx context.Context, req *api.UserRequest) (*api.UserResponse, error) {
	...
	if err != nil {
		return &api.UserResponse{}, errors.Wrap(err, "failed new user")
	}
	...
	if err != nil {
		return &api.UserResponse{}, errors.Wrap(err, "failed send new user activation token email")
	}
...
func (s *Handler) UpdateUserPassword(ctx context.Context, req *api.UpdateUserPasswordRequest) (*api.AcceptanceResponse, error) {
	...
	if err != nil {
		return &api.AcceptanceResponse{}, errors.Wrap(err, "failed update user password")
	}
